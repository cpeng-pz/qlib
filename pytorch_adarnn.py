...
class ADARNN(Model):
    ...
    def fit(
        ...
        train_splits = get_split_time(days, self.n_splits, df_train)
        train_splits = [df_train[s[0] : s[-1]] for s in train_splits]
        # train_splits[0].to_csv(r'D:\qlibexample\qlibexample\0.csv')
        # train_splits[1].to_csv(r'D:\qlibexample\qlibexample\1.csv')
